...
busline_df_column = [
    'id', 'code', 'type', 'search_name', 'key_name', 'name', 'front_name', 'terminal_name', 'company', 'status',
    'ic_card', 'air', 'total_price', 'start_time', 'end_time', 'interval', 'xs', 'ys', 'xs-84', 'ys-84'
]
station_df_column = [
    'station_id', 'name', 'busline_id', 'order', 'poiid1', 'xy_coords', 'xy_coords_84', 'poiid2', 'poiid2_xy',
    'poiid2_xy_84'
]
